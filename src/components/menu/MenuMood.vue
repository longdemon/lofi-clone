...
const listNoise = [
  {
    ...
    audioLink: "@/assets/effect/city_traffic.mp3"
  },
  {
    name: "City rain",
    idInput: "rain-volume",
    idAudio: "rain-audio",
    audioLink: "@/assets/effect/rain_city.mp3"
  },
  {
    name: "Fireplace",
    idInput: "fireplace-volume",
    idAudio: "fireplace-audio",
    audioLink: "@/assets/effect/fireplace.mp3"
  },
  {
    name: "Campfire",
    idInput: "campfire-volume",
    idAudio: "campfire-audio",
    audioLink: "@/assets/effect/campfire.mp3"
  },
  {
    name: "Forest Sounds",
    idInput: "forest-volume",
    idAudio: "forest-audio",
    audioLink: "@/assets/effect/forest_night.mp3"
  },
  {
    name: "Forest Rain",
    idInput: "forest-rain-volume",
    idAudio: "forest-rain-audio",
    audioLink: "@/assets/effect/rain_forest.mp3"
  },
  {
    name: "Waves",
    idInput: "waves-volume",
    idAudio: "waves-audio",
    audioLink: "@/assets/effect/waves.mp3"
  },
  {
    name: "Fan",
    idInput: "fan-volume",
    idAudio: "fan-audio",
    audioLink: "@/assets/effect/fan.mp3"
  },
  {
    name: "Summer Storm",
    idInput: "storm-volume",
    idAudio: "storm-audio",
    audioLink: "@/assets/effect/summer_storm.mp3"
  },
  {
    name: "River",
    idInput: "river-volume",
    idAudio: "river-audio",
    audioLink: "@/assets/effect/river.mp3"
  },
  {
    name: "Bird",
    idInput: "bird-volume",
    idAudio: "bird-audio",
    audioLink: "@/assets/effect/birds.mp3"
  },
  {
    name: "People Talking",
    idInput: "people-volume",
    idAudio: "people-audio",
    audioLink: "@/assets/effect/people_talk_inside.mp3"
  },
  {
    name: "River Talking",
    idInput: "river-volume",
